...
COMPILATIONUNIT     :   EOFF    {$$=addlabel("COMPILATIONUNIT");$1=addlabel(string("eoff") +  string("(") +  chartostring($1)+string(")"));addedge($$, $1);}
                    |   ORDINARYCOMPILATIONUNIT EOFF   {$$=addlabel("COMPILATIONUNIT");addedge($$, $1);$2=addlabel(string("eoff") +  string("(") +  chartostring($2)+string(")"));addedge($$, $2);}
