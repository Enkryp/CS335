...
/* Separators */
%token<val> COMMA QUESTIONMARK SEMICOLON  OPENCURLY CLOSECURLY ANGULARLEFT ANGULARRIGHT OPENSQUARE CLOSESQUARE OPENPARAN CLOSEPARAN DOUBLECOLON TRIPLEDOT
...
METHODINVOCATION: METHODNAME OPENPARAN CLOSEPARAN
                 ...
                 |	TYPENAME DOT IDENTIFIER OPENPARAN CLOSEPARAN
                 |	TYPENAME DOT IDENTIFIER OPENPARAN ARGUMENTLIST CLOSEPARAN
                 |	TYPENAME DOT TYPEARGUMENTS IDENTIFIER OPENPARAN CLOSEPARAN
                 |	TYPENAME DOT TYPEARGUMENTS IDENTIFIER OPENPARAN ARGUMENTLIST CLOSEPARAN
                 ...
                 |	TYPENAME DOT SUPER DOT IDENTIFIER OPENPARAN CLOSEPARAN
                 |	TYPENAME DOT SUPER DOT IDENTIFIER OPENPARAN ARGUMENTLIST CLOSEPARAN
                 |	TYPENAME DOT SUPER DOT TYPEARGUMENTS IDENTIFIER OPENPARAN CLOSEPARAN
                 |	TYPENAME DOT SUPER DOT TYPEARGUMENTS IDENTIFIER OPENPARAN ARGUMENTLIST CLOSEPARAN
