...
PRIMITIVETYPE   :   NUMERICTYPE  {$$=addlabel("PRIMITIVETYPE");addedge($$, $1);}
                |   BOOLEAN   {$$=addlabel("PRIMITIVETYPE");$1=addlabel("boolean" +  "(" +  chartostring($1)+")");addedge($$, $1);}
...
INTEGRALTYPE    : BYTE  {$$=addlabel("INTEGRALTYPE");$1=addlabel("byte" +  "(" +  chartostring($1)+")");addedge($$, $1);}
                ...
                | CHAR   {$$=addlabel("INTEGRALTYPE");$1=addlabel("char" +  "(" +  chartostring($1)+")");addedge($$, $1);}
FLOATINGTYPE    :   FLOAT  {$$=addlabel("FLOATINGTYPE");$1=addlabel("float" +  "(" +  chartostring($1)+")");addedge($$, $1);}
                |   DOUBLE   {$$=addlabel("FLOATINGTYPE");$1=addlabel("double" +  "(" +  chartostring($1)+")");addedge($$, $1);}
...
TOPLEVELCLASSORINTERFACEDECLARATION :   CLASSDECLARATION  {$$=addlabel("TOPLEVELCLASSORINTERFACEDECLARATION");addedge($$, $1);}
                                    |   SEMICOLON   {$$=addlabel("TOPLEVELCLASSORINTERFACEDECLARATION");$1=addlabel("semicolon" +  "(" +  chartostring($1)+")");addedge($$, $1);}
...
TYPEPARAMETER   :   IDENTIFIER TYPEBOUND  {$$=addlabel("TYPEPARAMETER");$1=addlabel("identifier" +  "(" +  chartostring($1)+")");addedge($$, $1);addedge($$, $2);}
                |   IDENTIFIER   {$$=addlabel("TYPEPARAMETER");$1=addlabel("identifier" +  "(" +  chartostring($1)+")");addedge($$, $1);}
...
FIELDDECLARATION    :   FIELDMODIFIERS TYPE VARIABLEDECLARATORLIST SEMICOLON  {$$=addlabel("FIELDDECLARATION");addedge($$, $1);addedge($$, $2);addedge($$, $3);$4=addlabel("semicolon" +  "(" +  chartostring($4)+")");addedge($$, $4);}
                    ...
                    |   TYPE VARIABLEDECLARATORLIST SEMICOLON   {$$=addlabel("FIELDDECLARATION");addedge($$, $1);addedge($$, $2);$3=addlabel("semicolon" +  "(" +  chartostring($3)+")");addedge($$, $3);}
...
DIMEXPR: OPENSQUARE EXPRESSION CLOSESQUARE   {$$=addlabel("DIMEXPR");$1=addlabel("opensquare" +  "(" +  chartostring($1)+")");addedge($$, $1);addedge($$, $2);$3=addlabel("closesquare" +  "(" +  chartostring($3)+")");addedge($$, $3);}
